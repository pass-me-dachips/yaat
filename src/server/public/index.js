...
const footerIcons = `
  ...
  <div class="f-t-c" onclick="navigateTowebpage('changelog.html')">
   ${changelogIcon}
   <div class="f-t-c-t">Changelog</div>
  </div>
  <div class="f-t-c" onclick="showTab('uptime-util')">
   ${uptimeIcon}
   <div class="f-t-c-t">Uptime</div>
  </div>
  <div class="f-t-c" onclick="showTab('docinfo-util')">
   ${docsIcon}
