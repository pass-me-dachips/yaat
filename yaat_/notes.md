always be at the directory where you want to run yaat commands. yaat will not change your current working directory and will only take the base name + you cwd.
